...
#### A MODULAR ROBOT: DISPLAY HINTS/TEACH KA SOLUTION:
...
#### EX2: ROADS MODULE DISPLAY HINTS:
...
Perhaps the cache ensures that the object is available, otherwise its empty?
...
Refer to 'EX3: DISPLAY HINTS:` above!